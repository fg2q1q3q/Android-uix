package me.shouheng.uix.pager.tab
...
class PagerTab : LinearLayout, ViewPager.OnPageChangeListener {
    ...
    private fun initPagerTab(context: Context, attrs: AttributeSet?) {
        ...
        selectTextSize = typedArray.getDimension(R.styleable.PagerTab_ptSelectTextSize, UIXUtils.sp2px(16f).toFloat())
        ...
        unSelectTextSize = typedArray.getDimension(R.styleable.PagerTab_ptUnSelectTextSize, UIXUtils.sp2px(16f).toFloat())
        ...
        indicatorToBottom = typedArray.getDimension(R.styleable.PagerTab_ptIndicatorToBottom, UIXUtils.dp2px(6f).toFloat()).toInt()
        tabToIndicator = typedArray.getDimension(R.styleable.PagerTab_ptTabToIndicator, UIXUtils.dp2px(2f).toFloat()).toInt()
        tabToTab = typedArray.getDimension(R.styleable.PagerTab_ptTabToTab, UIXUtils.dp2px(12f).toFloat()).toInt()
        ...
        mIndicatorLineWidth = typedArray.getDimension(R.styleable.PagerTab_ptIndicatorLineWidth, UIXUtils.dp2px(10f).toFloat()).toInt()
        mIndicatorLineHeight = typedArray.getDimension(R.styleable.PagerTab_ptIndicatorLineHeight, UIXUtils.dp2px(3f).toFloat()).toInt()
        mIndicatorLineRadius = typedArray.getDimension(R.styleable.PagerTab_ptIndicatorLineRadius, UIXUtils.dp2px(2f).toFloat()).toInt()
    ...
    fun linkageScrollTitleParentToCenter(position: Int, positionOffset: Float) {
        if (mTabParentView != null && mTabParentView!!.childCount > position) {
            ...
            val halfScreenWidth = UIXUtils.getScreenWidth() / 2
